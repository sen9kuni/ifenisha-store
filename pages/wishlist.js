        ...
        <>
            ...
            <div>
                <div className='bg-cart flex-col pt-[74px] pr-[521] pb-[74px] pl-[521]'>
                    <h className='cart-text mb-5 flex items-center justify-center'>Wishlist</h>
                ...
                <div className='grid grid-cols-5 pt-[40px] pr-[140px]  pl-[140px] gap-10 items-center'>
                    <Image className='col-span-1' src={'/images/wishlist-chair1.png'} alt={'chair'} width={170} height={172}/>
                ...
                <div className='grid grid-cols-5 pb-[120px] pt-[40px] pr-[140px]  pl-[140px] gap-10 items-center'>
                    <Image className='col-span-1' src={'/images/wishlist-chair1.png'} alt={'chair'} width={170} height={172}/>
